...
public final class TestCaseServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<edu.pict.testCaseService.DeleteRequest,
      edu.pict.testCaseService.DeleteResponse> getDeleteTestCasesByQuestionIDMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "deleteTestCasesByQuestionID",
      requestType = edu.pict.testCaseService.DeleteRequest.class,
      responseType = edu.pict.testCaseService.DeleteResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<edu.pict.testCaseService.DeleteRequest,
      edu.pict.testCaseService.DeleteResponse> getDeleteTestCasesByQuestionIDMethod() {
    io.grpc.MethodDescriptor<edu.pict.testCaseService.DeleteRequest, edu.pict.testCaseService.DeleteResponse> getDeleteTestCasesByQuestionIDMethod;
      ...
      synchronized (TestCaseServiceGrpc.class) {
        if ((getDeleteTestCasesByQuestionIDMethod = TestCaseServiceGrpc.getDeleteTestCasesByQuestionIDMethod) == null) {
          TestCaseServiceGrpc.getDeleteTestCasesByQuestionIDMethod = getDeleteTestCasesByQuestionIDMethod =
              io.grpc.MethodDescriptor.<edu.pict.testCaseService.DeleteRequest, edu.pict.testCaseService.DeleteResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "deleteTestCasesByQuestionID"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.pict.testCaseService.DeleteRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.pict.testCaseService.DeleteResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void deleteTestCasesByQuestionID(edu.pict.testCaseService.DeleteRequest request,
        io.grpc.stub.StreamObserver<edu.pict.testCaseService.DeleteResponse> responseObserver) {
  ...
  public static final class TestCaseServiceStub
    ...
    /**
     */
    public void deleteTestCasesByQuestionID(edu.pict.testCaseService.DeleteRequest request,
        io.grpc.stub.StreamObserver<edu.pict.testCaseService.DeleteResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class TestCaseServiceBlockingV2Stub
    ...
    /**
     */
    public edu.pict.testCaseService.DeleteResponse deleteTestCasesByQuestionID(edu.pict.testCaseService.DeleteRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class TestCaseServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<edu.pict.testCaseService.DeleteResponse> deleteTestCasesByQuestionID(
        edu.pict.testCaseService.DeleteRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_DELETE_TEST_CASES_BY_QUESTION_ID:
          serviceImpl.deleteTestCasesByQuestionID((edu.pict.testCaseService.DeleteRequest) request,
              (io.grpc.stub.StreamObserver<edu.pict.testCaseService.DeleteResponse>) responseObserver);
          break;
        default:
  ...
  public static final io.grpc.ServerServiceDefinition bindService(AsyncService service) {
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              edu.pict.testCaseService.DeleteRequest,
              edu.pict.testCaseService.DeleteResponse>(
