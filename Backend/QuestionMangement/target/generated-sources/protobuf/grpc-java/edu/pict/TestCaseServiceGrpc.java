...
public final class TestCaseServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<edu.pict.TestCases,
      edu.pict.TestCases> getStoreTestCasesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "storeTestCases",
      requestType = edu.pict.TestCases.class,
      responseType = edu.pict.TestCases.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<edu.pict.TestCases,
      edu.pict.TestCases> getStoreTestCasesMethod() {
    io.grpc.MethodDescriptor<edu.pict.TestCases, edu.pict.TestCases> getStoreTestCasesMethod;
      ...
      synchronized (TestCaseServiceGrpc.class) {
        if ((getStoreTestCasesMethod = TestCaseServiceGrpc.getStoreTestCasesMethod) == null) {
          TestCaseServiceGrpc.getStoreTestCasesMethod = getStoreTestCasesMethod =
              io.grpc.MethodDescriptor.<edu.pict.TestCases, edu.pict.TestCases>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "storeTestCases"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.pict.TestCases.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<edu.pict.TestCaseRequest,
      edu.pict.TestCaseResponse> getGetTestCasesByQuestionIdMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getTestCasesByQuestionId",
      requestType = edu.pict.TestCaseRequest.class,
      responseType = edu.pict.TestCaseResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<edu.pict.TestCaseRequest,
      edu.pict.TestCaseResponse> getGetTestCasesByQuestionIdMethod() {
    io.grpc.MethodDescriptor<edu.pict.TestCaseRequest, edu.pict.TestCaseResponse> getGetTestCasesByQuestionIdMethod;
      ...
      synchronized (TestCaseServiceGrpc.class) {
        if ((getGetTestCasesByQuestionIdMethod = TestCaseServiceGrpc.getGetTestCasesByQuestionIdMethod) == null) {
          TestCaseServiceGrpc.getGetTestCasesByQuestionIdMethod = getGetTestCasesByQuestionIdMethod =
              io.grpc.MethodDescriptor.<edu.pict.TestCaseRequest, edu.pict.TestCaseResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getTestCasesByQuestionId"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.pict.TestCaseRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.pict.TestCaseResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void storeTestCases(edu.pict.TestCases request,
        io.grpc.stub.StreamObserver<edu.pict.TestCases> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getStoreTestCasesMethod(), responseObserver);
    }

    /**
     */
    default void getTestCasesByQuestionId(edu.pict.TestCaseRequest request,
  ...
  public static final class TestCaseServiceStub
    ...
    /**
     */
    public void storeTestCases(edu.pict.TestCases request,
        io.grpc.stub.StreamObserver<edu.pict.TestCases> responseObserver) {
    ...
    /**
     */
    public void getTestCasesByQuestionId(edu.pict.TestCaseRequest request,
        io.grpc.stub.StreamObserver<edu.pict.TestCaseResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class TestCaseServiceBlockingV2Stub
    ...
    /**
     */
    public edu.pict.TestCases storeTestCases(edu.pict.TestCases request) {
  ...
  public static final class TestCaseServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<edu.pict.TestCases> storeTestCases(
        edu.pict.TestCases request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<edu.pict.TestCaseResponse> getTestCasesByQuestionId(
        edu.pict.TestCaseRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_STORE_TEST_CASES:
          serviceImpl.storeTestCases((edu.pict.TestCases) request,
              (io.grpc.stub.StreamObserver<edu.pict.TestCases>) responseObserver);
          break;
  ...
  private static abstract class TestCaseServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return edu.pict.TestcaseServiceProto.getDescriptor();
    }
